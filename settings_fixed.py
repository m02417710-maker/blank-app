...
class AppConfig:
    ...
    # ✅ Fix CFG-1: was missing → AttributeError in ai_engine.py
    ...
    COMMISSION: float = 0.00185  # ✅ EGX official 18.5 bps
    ...
    def __post_init__(self) -> None:
        """تهيئة القيم الافتراضية بعد إنشاء الكائن."""
...
# ✅ Fix CFG-2: alias for core/*.py that import app_config
app_config = config
